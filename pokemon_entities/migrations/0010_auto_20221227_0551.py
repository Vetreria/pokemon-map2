# Generated by Django 3.1.14 on 2022-12-27 02:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='appeared_at',
            field=models.DateTimeField(null=True, verbose_name='Начало спауна'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='defence',
        ...
        migrations.AlterField(
            model_name='pokemonentity',
            name='disappeared_at',
            field=models.DateTimeField(null=True, verbose_name='Конец спауна'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='health',
        ...
        migrations.AlterField(
            model_name='pokemonentity',
            name='pokemon',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='entities', to='pokemon_entities.pokemon', verbose_name='Что за покемон'),
        ),
        migrations.AlterField(
            model_name='pokemonentity',
            name='stamina',
